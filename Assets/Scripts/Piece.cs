...
public class Piece : MonoBehaviour
{
    ...
    private void Update() {
        ...
        } else if (Input.GetKeyDown(KeyCode.S) || Input.GetKeyDown(KeyCode.DownArrow)) { // down or soft-drop
            Move(Vector2Int.down);
        } else if (Input.GetKeyDown(KeyCode.W) || Input.GetKeyDown(KeyCode.UpArrow)) { // rotate right
            Rotate(1);
        } else if (Input.GetKeyDown(KeyCode.Z)) { // rotate right
            Rotate(-1);
    ...
    private bool TestWallKicks(int rotationMatrix, int rotationDirection) {
        int wallKickIndex = GetWallKickIndex(rotationMatrix, rotationDirection);
    ...
    private int GetWallKickIndex(int rotationMatrix, int rotationDirection) {
